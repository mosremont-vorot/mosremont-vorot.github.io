...
Photos[0]= new Photo("./photos/5-remont-vorot_thumb.jpg","./photos/5-remont-vorot.jpg",1024,768,"5-remont-vorot.jpg",null);
Photos[1]= new Photo("./photos/avtomaticheskie-rashpashnie-vorota_1_thumb.jpg","./photos/avtomaticheskie-rashpashnie-vorota_1.jpg",1024,768,"avtomaticheskie-rashpashnie-vorota.jpg",null);
Photos[2]= new Photo("./photos/avtomatika_thumb.jpg","./photos/avtomatika.jpg",1024,663,"avtomatika.jpg",null);
Photos[3]= new Photo("./photos/otkat-vor-dorkhan-vorota-Standart_thumb.jpg","./photos/otkat-vor-dorkhan-vorota-Standart.jpg",1024,483,"otkat-vor-dorkhan-vorota-Standart.jpg",null);
Photos[4]= new Photo("./photos/sekcii_1_thumb.jpg","./photos/sekcii_1.jpg",1024,776,"sekcii.jpg",null);
LMObjects[objindex++] = LMGal("Gal1",1,1,0,0,Photos,4000,"Slide", "./", 537, 1, 1, 1, 0, 1, 1, 1, 1, 0, 1, 0);
//---------------------------------------------------------------------------------------------
}
}catch(e) {
alert(e.message);
